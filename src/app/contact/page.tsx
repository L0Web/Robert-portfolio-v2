        ...
        <div className="min-h-screen pt-6 mb-10 max-w-[var(--max-width)] m-auto">
            <div className="flex flex-col gap-6">
                ...
                <div className="relative px-2 lg:px-6 py-4">
                    ...
                    <form ref={form} onSubmit={handleSubmit} id="email-form" action="" className="flex flex-col gap-2 md:gap-4">
                        {
                            sendingError ?
                        ...
                        <div className="grid grid-cols-1 grid-rows-[auto_1fr] md:grid-rows-1 md:grid-cols-[1fr,_2fr] lg:grid-cols-2 gap-0 md:gap-4 pt-4 pb-2 md:pt-0 md:pb-0 px-4 md:px-6 bg-black/10 dark:bg-white/10 items-center rounded-2xl md:rounded-[32px]">
                            ...
                            <input type="text" id="from_name" name="from_name" className="h-10 md:h-16 text-base md:text-lg tracking-tight placeholder:text-gray-400 font-geist bg-transparent dark:text-white/80 dark:placeholder:text-white/50 focus:outline-none" placeholder="Your Name" />
                        </div>
                        <div className="grid grid-cols-1 grid-rows-[auto_1fr] md:grid-rows-1 md:grid-cols-[1fr,_2fr] lg:grid-cols-2 gap-0 md:gap-4 pt-4 pb-2 md:pt-0 md:pb-0 px-4 md:px-6 bg-black/10 dark:bg-white/10 items-center rounded-2xl md:rounded-[32px]">
                            ...
                            <input type="text" id="from_email" name="from_email" className="h-10 md:h-16 text-base md:text-lg tracking-tight placeholder:text-gray-400 dark:placeholder:text-white/50 dark:text-white/80 font-geist bg-transparent focus:outline-none" placeholder="name@company.com" />
                        </div>
                        ...
                        <div className="grid grid-cols-1 grid-rows-[auto_1fr] md:grid-rows-1 md:grid-cols-[1fr,_2fr] lg:grid-cols-2 gap-0 md:gap-4 sm:pt-2 pb-2 md:pt-0 md:pb-0 px-4 md:px-6 bg-black/10 dark:bg-white/10 rounded-2xl md:rounded-[32px]">
                            ...
                            <textarea id="message" name="message" className="h-32 py-4 text-base md:text-lg tracking-tight placeholder:text-gray-400 dark:placeholder:text-white/50 dark:text-white/80 font-geist bg-transparent focus:outline-none" placeholder="Write here"></textarea>
                        </div>
